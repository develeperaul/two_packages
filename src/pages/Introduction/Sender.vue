...
const steps = [
  ...
  {
    img: "2_sender",
    text: "Наш сервис поможет Вам доставить Вашу посылку легко, быстро и безопасно.",
  },
  {
    img: "3_sender",
    text: "Выберите маршрут и дату. Далее наш сервис предложит Вам перевозчиков которые готовы доставить Вашу посылку быстро и безопасно. Остается только оплатить доставку, передать перевозчику посылку и ждать подтверждения доставки.",
  },
];
export default {
  // name: 'PageName',
